...
public class BobCatWaitClass {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//wait.until(ExpectedConditions.elementToBeClickable(driver.findElement(By.xpath("//img[contains(@alt,'Rental Condition')]"))));
		...
		wait.until(ExpectedConditions.visibilityOf(driver.findElement(By.xpath("//h3[@class='light-title']"))));
